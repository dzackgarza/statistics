...
star.sample2 <- subset(test.data, School.Code %in% codes.sample1)

# Write shortcuts
mean1 <- star.sample1$Mean.Scale.Score
mean2 <- star.sample2$Mean.Scale.Score
...
hist(elig2, main="Proportion of Students Eligible for FRPM, Sample 2", xlab="Proportion", ylab="Number of Schools")
@
\caption{Proportions.}
